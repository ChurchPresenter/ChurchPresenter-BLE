...
object ReplayEval {
     ...
     * 2026-07-24. Older recordings carry the primary Bible's own numbering instead, which only agrees
    ...
    fun main(args: Array<String>) {
        ...
        // service as a miss: on 2026-07-22 the operator walked Psalm 24 twice, and 3 of the 5
